...
Version  : 1.0.0
Release  : 3
URL      : https://github.com/kata-containers/shim/archive/1.0.0.tar.gz
Source0  : https://github.com/kata-containers/shim/archive/1.0.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1527008035
