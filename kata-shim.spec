...
Version  : 1.3.1
Release  : 10
URL      : https://github.com/kata-containers/shim/archive/1.3.1.tar.gz
Source0  : https://github.com/kata-containers/shim/archive/1.3.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1540591426
