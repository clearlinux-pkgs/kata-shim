...
Version  : 1.6.2
Release  : 18
URL      : https://github.com/kata-containers/shim/archive/1.6.2/shim-1.6.2.tar.gz
Source0  : https://github.com/kata-containers/shim/archive/1.6.2/shim-1.6.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1555628861
