...
Version  : 1.5.0
Release  : 13
URL      : https://github.com/kata-containers/shim/archive/1.5.0.tar.gz
Source0  : https://github.com/kata-containers/shim/archive/1.5.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1548264933
