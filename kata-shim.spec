...
Version  : 0.2.0
Release  : 2
URL      : https://github.com/kata-containers/shim/archive/0.2.0.tar.gz
Source0  : https://github.com/kata-containers/shim/archive/0.2.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1526672620
