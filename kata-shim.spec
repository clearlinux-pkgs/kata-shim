...
Version  : 1.8.2
Release  : 19
URL      : https://github.com/kata-containers/shim/archive/1.8.2/shim-1.8.2.tar.gz
Source0  : https://github.com/kata-containers/shim/archive/1.8.2/shim-1.8.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570470192
