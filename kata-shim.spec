...
Version  : 1.5.1
Release  : 15
URL      : https://github.com/kata-containers/shim/archive/1.5.1.tar.gz
Source0  : https://github.com/kata-containers/shim/archive/1.5.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1552926099
