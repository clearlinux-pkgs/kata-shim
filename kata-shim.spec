...
Version  : 0.0.1
Release  : 1
URL      : https://github.com/kata-containers/shim/archive/0.0.1.tar.gz
Source0  : https://github.com/kata-containers/shim/archive/0.0.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1526488684
